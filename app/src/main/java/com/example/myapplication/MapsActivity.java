...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.B_Search:
                ...
                Toast.makeText(this , "Showing Nearby NGOs", Toast.LENGTH_LONG ).show();
                break;
            ...
            case R.id.B_School :
                ...
                Toast.makeText(this , "Showing Nearby Lawyers", Toast.LENGTH_LONG ).show();
                break;
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyDxlJOUFeFTY-85XOK52oSqWKkYWfF4tHY");
